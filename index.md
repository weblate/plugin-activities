...
* [bugs and features](https://github.com/galette-plugins/plugin-activities/issues)
...
* or using the [source code from the repository](https://github.com/galette-plugins/plugin-activities),
